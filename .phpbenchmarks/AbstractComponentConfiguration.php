...
abstract class AbstractComponentConfiguration
{
    ...
    {
        return [
            'entryPoint' => 'https://github.com/phpbenchmarks/twig-common/blob/twig_2_hello-world/helloworld.php',
            'template' => 'https://github.com/phpbenchmarks/twig-common/blob/twig_2_hello-world/templates/helloworld.html.twig'
        ];
    }
}